...
$$
\max Z = \sum_{i=2024}^{2030} \sum_{j=1}^{54} \sum_{k=1}^{2} \sum_{l=1}^{41} ( P'_{i,k,l} \times Q'_{i,j,k,l} - C'_{i,j,k,l} ) \times x_{i,j,k,l} (32)
$$
...
$$
Q'_{i,k,l} = Q_{i,k,l} \times (1 - \frac{P'_{i,k,l} - \bar{P}_{i,k,S}}{\bar{P}_{i,k,S}}) (34)
$$
...
$$
P'_{i,k,l} = P_{i,k,l} \times (1 - \frac{Q''_{i,k,l} - Q_{i-1,k,l}}{Q_{i-1,k,l}})
$$
...
$$
C'_{i,j,k,l} = C_{i,j,k,l} \times (1 + \frac{Q''_{i,k,l} - Q_{i-1,k,l}}{Q_{i-1,k,l}}) (36)
$$
...
$$
\max Z = \sum_{i=2024}^{2030} \sum_{j=1}^{54} \sum_{k=1}^{2} \sum_{l=1}^{41} ( P'_{i,k,l} \times Q''_{i,j,k,l} - C'_{i,j,k,l} ) \times x_{i,j,k,l} (37)
$$
