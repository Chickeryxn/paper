...
$$
i = \begin{cases} 0, & \text{第一季度} \\ 1, & \text{第二季度} \end{cases} (3)
$$
...
$$
Y_{tijk} = \begin{cases} 0, & \text{第 } i \text{ 季度未在第 } j \text{ 块地上种植作物 } k \\ 1, & \text{第 } i \text{ 季度在第 } j \text{ 块地上种植作物 } k \end{cases} (4)
$$
...
$$
X_{tijk} \leq M \cdot Y_{tijk} \quad \forall t, i, j, k (5)
$$
...
$$
X_{tijk} \geq 0.01 \cdot Y_{tijk} \quad \forall t, i, j, k (6)
$$
...
$$
I_k = \begin{cases} 0, & k \text{ 为豆类作物} \\ 1, & k \text{ 非豆类作物} \end{cases} (7)
$$
...
$$
T_j = \begin{cases} 1, & \text{平旱地} \\ 2, & \text{梯田} \\ 3, & \text{山坡地} \\ 4, & \text{水浇地} \\ 5, & \text{普通大棚} \\ 6, & \text{智慧大棚} \end{cases} (8)
$$
...
$$
Z = \sum_{t,i,k} ( \text{Price}_{ik} \cdot Z_{tik} - \sum_j \text{Cost}_{ijk} \cdot X_{tijk} ) (11)
$$
...
$$
Z = \sum_{t,i,k} ( \text{Price}_{ik} \cdot Z_{tik} + 0.5 \cdot \text{Price}_{ik} \cdot Z_{\text{excess},tik} - \sum_j \text{Cost}_{ijk} \cdot X_{tijk} ) (12)
$$
...
$$
\sum_k X_{tijk} \leq S_j \quad \forall t, i, j (13)
$$
...
$$
Z_{tik} \leq \sum_j \text{Produce}_{ijk} \cdot X_{tijk} \quad \forall t, i, k (14)
$$
...
$$
Z_{tik} \leq \text{Request}_{ik} \quad \forall t, i, k (15)
$$
...
$$
Z_{\text{excess},tik} = \sum_j ( \text{Produce}_{tijk} \cdot X_{tijk} - \text{Request}_{ik} ) (16)
$$
...
$$
X_{t,0,j,k} + X_{t+1,0,j,k} \leq S_j \quad \forall t, j, k \in \{1, 2, \ldots, 15\} (17)
$$
...
$$
Y_{t0jk} Y_{t1jk} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 (18)
$$
...
$$
Y_{t0jk} Y_{(t-1)1jk} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 (19)
$$
...
$$
Y_{t1jk} Y_{(t+1)jk} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 (20)
$$
...
$$
\sum_{t=t_0}^{t_0+2} \sum_i \sum_k I_k \cdot X_{tijk} \geq S_j \quad \forall j (21)
$$
...
$$
Y_{tijk} = 1 \quad \forall t, i, k \in \{1, 2, \ldots, 15\}, T_j \in \{1, 2, 3\} (22)
$$
...
$$
Y_{tijk} = 1 \quad \forall t, i, k = 16, T_j = 4 (23)
$$
...
$$
Y_{t016k} \cdot Y_{t0jk} = 0 \quad \forall t, k \in \{17, \ldots, 37\}, T_j = 4 (24)
$$
...
$$
Y_{t0jk} = 0 \quad \forall t, k \notin \{1, 2, \ldots, 15\}, T_j \in \{1, 2, 3\} (25)
$$
...
$$
\sum_k Y_{tijk} \leq p \quad \forall t, i, j (32)
$$
...
$$
\sum_j Y_{tijk} \leq q \quad \forall t, i, k (33)
$$
...
$$
\text{s.t.} = \begin{cases} Z = \sum_{t,i,k} ( \text{Price}_{ik} \cdot Z_{tik} - \sum_j \text{Cost}_{ijk} \cdot X_{tijk} ) \\ \sum_k X_{tijk} \leq S_j \quad \forall t, i, j \\ Z_{tik} \leq \sum_j \text{Produce}_{ijk} \cdot X_{tijk} \quad \forall t, i, k \\ Z_{tik} \leq \text{Request}_{ik} \quad \forall t, i, k \\ X_{t,0,j,k} + X_{t+1,0,j,k} \leq S_j \quad \forall t, j, k \in \{1, 2, \ldots, 15\} \\ Y_{t0jk} \cdot Y_{t1jk} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ Y_{t0jk} \cdot Y_{(t-1)1jk} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ Y_{t1jk} \cdot Y_{(t+1)jk} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ \sum_{t=t_0}^{t_0+2} \sum_i \sum_k I_k \cdot X_{tijk} \geq S_j \quad \forall j \\ Y_{tijk} = 1 \quad \forall t, i, k \in \{1, 2, \ldots, 15\}, T_j \in \{1, 2, 3\} \\ Y_{tijk} = 1 \quad \forall t, i, k = 16, T_j = 4 \\ Y_{t016k} \cdot Y_{t0jk} = 0 \quad \forall t, k \in \{17, \ldots, 37\}, T_j = 4 \\ Y_{t0jk} = 0 \quad \forall t, k \notin \{1, 2, \ldots, 15\}, T_j \in \{1, 2, 3\} \\ Y_{t0jk} = 0 \quad \forall t, i \neq 16, T_j = 4 \\ Y_{t0jk} = 0 \quad \forall t, i \notin \{17, 18, \ldots, 34\}, T_j = 4 \\ Y_{t1jk} = 0 \quad \forall t, i \notin \{35, 36, 37\}, T_j = 4 \\ Y_{t0jk} = 0 \quad \forall t, k \notin \{17, 18, \ldots, 34\}, T_j = 5 \\ Y_{t1jk} = 0 \quad \forall t, k \notin \{38, 39, \ldots, 41\}, T_j = 5 \\ Y_{tijk} = 0 \quad \forall t, i, k \notin \{17, 18, \ldots, 34\}, T_j = 6 \\ \sum_k Y_{tijk} \leq p \quad \forall t, i, j \\ \sum_j Y_{tijk} \leq q \quad \forall t, i, k \end{cases} (35)
$$
...
$$
\text{s.t.} = \begin{cases} Z = \sum_{t,i,k}( \text{Price}_{ik} \cdot Z_{tik} + 0.5 \cdot \text{Price}_{ik} \cdot Z_{\text{excess},tik} - \sum_j \text{Cost}_{ijk} \cdot X_{tijk} ) \\ \sum_k X_{tijk} \leq S_j \quad \forall t, i, j \\ Z_{tik} \leq \sum_j \text{Produce}_{ijk} \cdot X_{tijk} \quad \forall t, i, k \\ Z_{\text{excess},tik} = \sum_j ( \text{Produce}_{tijk} \cdot X_{tijk} - \text{Request}_{ik} ) \\ X_{t,0,j,k} + X_{t+1,0,j,k} \leq S_j \quad \forall t, j, k \in \{1, 2, \ldots, 15\} \\ Y_{0jk}^t Y_{1jk}^t = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ Y_{0jk}^t Y_{1jk}^{(t-1)} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ Y_{1jk}^t Y_{jk}^{(t+1)} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ \sum_{t=t_0}^{t_0+2} \sum_i \sum_k I_k \cdot X_{tijk} \geq S_j \quad \forall j \\ Y_{tijk} = 1 \quad \forall t, i, k \in \{1, 2, \ldots, 15\}, T_j \in \{1, 2, 3\} \\ Y_{tijk} = 1 \quad \forall t, i, k = 16, T_j = 4 \\ Y_{016k}^t \cdot Y_{0jk}^t = 0 \quad \forall t, k \in \{17, \ldots, 37\}, T_j = 4 \\ Y_{0jk}^t = 0 \quad \forall t, k \notin \{1, 2, \ldots, 15\}, T_j \in \{1, 2, 3\} \\ Y_{0jk}^t = 0 \quad \forall t, i \neq 16, T_j = 4 \\ Y_{0jk}^t = 0 \quad \forall t, i \notin \{17, 18, \ldots, 34\}, T_j = 4 \\ Y_{1jk}^t = 0 \quad \forall t, i \notin \{35, 36, 37\}, T_j = 4 \\ Y_{0jk}^t = 0 \quad \forall t, k \notin \{17, 18, \ldots, 34\}, T_j = 5 \\ Y_{1jk}^t = 0 \quad \forall t, k \notin \{38, 39, \ldots, 41\}, T_j = 5 \\ Y_{tijk} = 0 \quad \forall t, i, k \notin \{17, 18, \ldots, 34\}, T_j = 6 \\ \sum_k Y_{tijk} \leq p \quad \forall t, i, j \\ \sum_j Y_{tijk} \leq q \quad \forall t, i, k \end{cases} (36)
$$
...
$$
E(\text{income}(A_n)^s) = \sum_s ( \text{income}(A_n)^s \cdot P_s ) (38)
$$
...
$$
\text{income}(A_n)^s = \sum_{t,i,k} ( \text{Price}_{tik}^s \cdot Z_{tik} - \sum_j \text{Cost}_{tijk}^s \cdot X_{tijk} ) (39)
$$
...
$$
\max ( \sum_s \text{income}(A_n)^s \cdot P_s ) (40)
$$
...
$$
\text{s.t.} = \begin{cases} \text{income}(A_n)^s = \sum_{t,i,k} ( \text{Price}_{tik} \cdot Z_{tik} - \sum_j \text{Cost}_{tijk} \cdot X_{tijk} ) \\ \sum_k X_{tijk} \leq S_j \quad \forall t, i, j \\ Z_{tik} \leq \sum_j \text{Produce}_{ijk} \cdot X_{tijk} \quad \forall t, i, k \\ Z_{tik} \leq \text{Request}_{tik} \quad \forall t, i, k \\ X_{t,0,j,k} + X_{t+1,0,j,k} \leq S_j \quad \forall t, j, k \in \{1, 2, \ldots, 15\} \\ Y_{0jk}^t Y_{1jk}^t = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ Y_{0jk}^t Y_{1jk}^{(t-1)} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ Y_{1jk}^t Y_{jk}^{(t+1)} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ \sum_{t=t_0}^{t_0+2} \sum_i \sum_k I_k \cdot X_{tijk} \geq S_j \quad \forall j \\ Y_{tijk} = 1 \quad \forall t, i, k \in \{1, 2, \ldots, 15\}, T_j \in \{1, 2, 3\} \\ Y_{tijk} = 1 \quad \forall t, i, k = 16, T_j = 4 \\ Y_{016k}^t \cdot Y_{0jk}^t = 0 \quad \forall t, k \in \{17, \ldots, 37\}, T_j = 4 \\ Y_{0jk}^t = 0 \quad \forall t, k \notin \{1, 2, \ldots, 15\}, T_j \in \{1, 2, 3\} \\ Y_{0jk}^t = 0 \quad \forall t, i \neq 16, T_j = 4 \\ Y_{0jk}^t = 0 \quad \forall t, i \notin \{17, 18, \ldots, 34\}, T_j = 4 \\ Y_{1jk}^t = 0 \quad \forall t, i \notin \{35, 36, 37\}, T_j = 4 \\ Y_{0jk}^t = 0 \quad \forall t, k \notin \{17, 18, \ldots, 34\}, T_j = 5 \\ Y_{1jk}^t = 0 \quad \forall t, k \notin \{38, 39, \ldots, 41\}, T_j = 5 \\ Y_{tijk} = 0 \quad \forall t, i, k \notin \{17, 18, \ldots, 34\}, T_j = 6 \\ \sum_k Y_{tijk} \leq p \quad \forall t, i, j \\ \sum_j Y_{tijk} \leq q \quad \forall t, i, k \end{cases} (41)
$$
...
$$
E(income(A_n)^s) = (\sum_s income(A_n)^s \cdot P_s) (47)
$$
...
$$
income(A_n)^s = \sum_{t,i,k}(Price^s_{tik} \cdot Z_{tik} - \sum_j Cost^s_{tijk} \cdot X_{tijk}) (48)
$$
...
$$
Max(\sum_s income(A_n)^s \cdot P_s) (49)
$$
...
I = 2
 ...
 = 54 20 K = 41 21 p=4 22 q=5 23 M=100000 24 S = data1['地块面积/亩'].tolist()
_k = data2['Ik'].tolist()
rice = [[3.25,7.5,8.25,7,6.75,
...
equest=[[57000,21850,22400,33040,9875,
...
f1 = pd.read_excel('cost.xlsx',sheet_name='第一季')
f2 = pd.read_excel('cost.xlsx',sheet_name='第二季')
ost1 = df1.values.transpose()
ost2 = df2.values.transpose()
ost=[Cost1,Cost2]
f3 = pd.read_excel('Produce.xlsx',sheet_name='第一季')
f4 = pd.read_excel('Produce.xlsx',sheet_name='第二季')
roduce1 = df3.values.transpose()
roduce2 = df4.values.transpose()
roduce=[Produce1,Produce2]
60 # 创建模型
odel = gp.Model("Crop_Planting")
63 #决策变量：
 = model.addVars(T, I, J, K, vtype=GRB.CONTINUOUS, name="X")
 = model.addVars(T, I, J, K, vtype=GRB.BINARY, name="Y")
_rice = model.addVars(T, range(27, 35), vtype=GRB.BINARY, name="Z_Rice")
 = model.addVars(T, I, K, vtype=GRB.CONTINUOUS, name="Z_Sold")
_excess = model.addVars(T, I, K, vtype=GRB.CONTINUOUS, name="Z_Excess")
69 # 定义目标函数
odel.setObjective(
p.quicksum(
rice[i][k] * Z[t, i, k] + 0.5 * Price[i][k] * Z_excess[t, i, k]
73 - gp.quicksum(Cost[i][j][k] * X[t, i, j, k] for j in range(J))
or t in range(T) for i in range(I) for k in range(K)
75 ),
RB.MAXIMIZE
77 )
79 # 添加约束：Z_sold 不能超过需求
odel.addConstrs((Z[t, i, k] <= Request[i][k] for t in range(T) for i in range(I) for k in range(K)), name="Sold_Limit")
82 # 添加约束：Z_sold 不能超过总产量
odel.addConstrs((Z[t, i, k] <= gp.quicksum(Produce[i][j][k] * X[t, i, j, k] for j in range(J))
or t in range(T) for i in range(I) for k in range(K)), name="Production_Limit_Sold")
86 # 添加约束：超出部分 Z_excess
odel.addConstrs((Z_excess[t, i, k] == gp.quicksum(Produce[i][j][k] * X[t, i, j, k] for j in range(J)) - Z[t, i, k]
or t in range(T) for i in range(I) for k in range(K)), name="Excess_Calculation")
90 #约束3：是否种植该作物
odel.addConstrs((X[t, i, j, k] <= M * Y[t, i, j, k]
or t in range(T) for i in range(I) for j in range(J) for k in range(K)),
ame="X_UpperBound_Y")
odel.addConstrs((X[t, i, j, k] >= 0.01 * Y[t, i, j, k]
or t in range(T) for i in range(I) for j in range(J) for k in range(K)),
ame="X_LowerBound_Y")
...
f year >= 2025:
ast_two_years_bean_area = 0
96     # 计算前两年的豆类作物种植面积
or past_year in range(year - 2, year):
f land_name in planting_history and past_year in planting_history[land_name]:
or season in planting_history[land_name][past_year].values():
