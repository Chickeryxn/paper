...
$$
Z = \sum_{t,i,k} \left( \text{Price}_{ik} \cdot Z_{tik} - \sum_j \text{Cost}_{ijk} \cdot X_{tijk} \right) (11)
$$
...
$$
Z = \sum_{t,i,k} \left( \text{Price}_{ik} \cdot Z_{tik} + 0.5 \cdot \text{Price}_{ik} \cdot Z_{\text{excess},tik} - \sum_j \text{Cost}_{ijk} \cdot X_{tijk} \right) (12)
$$
...
$$
Z_{\text{excess},tik} = \sum_j \left( \text{Produce}_{tijk} \cdot X_{tijk} - \text{Request}_{ik} \right) (16)
$$
...
$$
\text{s.t.} = \begin{cases} Z = \sum_{t,i,k}\left( \text{Price}_{ik} \cdot Z_{tik} + 0.5 \cdot \text{Price}_{ik} \cdot Z_{\text{excess},tik} - \sum_j \text{Cost}_{ijk} \cdot X_{tijk} \right) \\ \sum_k X_{tijk} \leq S_j \quad \forall t, i, j \\ Z_{tik} \leq \sum_j \text{Produce}_{ijk} \cdot X_{tijk} \quad \forall t, i, k \\ Z_{\text{excess},tik} = \sum_j \left( \text{Produce}_{tijk} \cdot X_{tijk} - \text{Request}_{ik} \right) \\ X_{t,0,j,k} + X_{t+1,0,j,k} \leq S_j \quad \forall t, j, k \in \{1, 2, \ldots, 15\} \\ Y_{0jk}^t Y_{1jk}^t = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ Y_{0jk}^t Y_{1jk}^{(t-1)} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ Y_{1jk}^t Y_{jk}^{(t+1)} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ \sum_{t=t_0}^{t_0+2} \sum_i \sum_k I_k \cdot X_{tijk} \geq S_j \quad \forall j \\ Y_{tijk} = 1 \quad \forall t, i, k \in \{1, 2, \ldots, 15\}, T_j \in \{1, 2, 3\} \\ Y_{tijk} = 1 \quad \forall t, i, k = 16, T_j = 4 \\ Y_{016k}^t \cdot Y_{0jk}^t = 0 \quad \forall t, k \in \{17, \ldots, 37\}, T_j = 4 \\ Y_{0jk}^t = 0 \quad \forall t, k \notin \{1, 2, \ldots, 15\}, T_j \in \{1, 2, 3\} \\ Y_{0jk}^t = 0 \quad \forall t, i \neq 16, T_j = 4 \\ Y_{0jk}^t = 0 \quad \forall t, i \notin \{17, 18, \ldots, 34\}, T_j = 4 \\ Y_{1jk}^t = 0 \quad \forall t, i \notin \{35, 36, 37\}, T_j = 4 \\ Y_{0jk}^t = 0 \quad \forall t, k \notin \{17, 18, \ldots, 34\}, T_j = 5 \\ Y_{1jk}^t = 0 \quad \forall t, k \notin \{38, 39, \ldots, 41\}, T_j = 5 \\ Y_{tijk} = 0 \quad \forall t, i, k \notin \{17, 18, \ldots, 34\}, T_j = 6 \\ \sum_k Y_{tijk} \leq p \quad \forall t, i, j \\ \sum_j Y_{tijk} \leq q \quad \forall t, i, k \end{cases} (36)
$$
...
$$
E(\text{income}(A_n)^s) = \sum_s \left( \text{income}(A_n)^s \cdot P_s \right) (38)
$$
...
$$
\text{income}(A_n)^s = \sum_{t,i,k} \left( \text{Price}_{tik}^s \cdot Z_{tik} - \sum_j \text{Cost}_{tijk}^s \cdot X_{tijk} \right) (39)
$$
...
$$
\max \left( \sum_s \text{income}(A_n)^s \cdot P_s \right) (40)
$$
...
$$
\text{s.t.} = \begin{cases} \text{income}(A_n)^s = \sum_{t,i,k} \left( \text{Price}_{tik} \cdot Z_{tik} - \sum_j \text{Cost}_{tijk} \cdot X_{tijk} \right) \\ \sum_k X_{tijk} \leq S_j \quad \forall t, i, j \\ Z_{tik} \leq \sum_j \text{Produce}_{ijk} \cdot X_{tijk} \quad \forall t, i, k \\ Z_{tik} \leq \text{Request}_{tik} \quad \forall t, i, k \\ X_{t,0,j,k} + X_{t+1,0,j,k} \leq S_j \quad \forall t, j, k \in \{1, 2, \ldots, 15\} \\ Y_{0jk}^t Y_{1jk}^t = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ Y_{0jk}^t Y_{1jk}^{(t-1)} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ Y_{1jk}^t Y_{jk}^{(t+1)} = 0 \quad \forall t, k \in \{17, 18, \ldots, 37\}, T_j = 6 \\ \sum_{t=t_0}^{t_0+2} \sum_i \sum_k I_k \cdot X_{tijk} \geq S_j \quad \forall j \\ Y_{tijk} = 1 \quad \forall t, i, k \in \{1, 2, \ldots, 15\}, T_j \in \{1, 2, 3\} \\ Y_{tijk} = 1 \quad \forall t, i, k = 16, T_j = 4 \\ Y_{016k}^t \cdot Y_{0jk}^t = 0 \quad \forall t, k \in \{17, \ldots, 37\}, T_j = 4 \\ Y_{0jk}^t = 0 \quad \forall t, k \notin \{1, 2, \ldots, 15\}, T_j \in \{1, 2, 3\} \\ Y_{0jk}^t = 0 \quad \forall t, i \neq 16, T_j = 4 \\ Y_{0jk}^t = 0 \quad \forall t, i \notin \{17, 18, \ldots, 34\}, T_j = 4 \\ Y_{1jk}^t = 0 \quad \forall t, i \notin \{35, 36, 37\}, T_j = 4 \\ Y_{0jk}^t = 0 \quad \forall t, k \notin \{17, 18, \ldots, 34\}, T_j = 5 \\ Y_{1jk}^t = 0 \quad \forall t, k \notin \{38, 39, \ldots, 41\}, T_j = 5 \\ Y_{tijk} = 0 \quad \forall t, i, k \notin \{17, 18, \ldots, 34\}, T_j = 6 \\ \sum_k Y_{tijk} \leq p \quad \forall t, i, j \\ \sum_j Y_{tijk} \leq q \quad \forall t, i, k \end{cases} (41)
$$
...
$$
E(income(A_n)^s) = \left(\sum_s income(A_n)^s \cdot P_s\right) (47)
$$
...
$$
income(A_n)^s = \sum_{t,i,k}\left(Price^s_{tik} \cdot Z_{tik} - \sum_j Cost^s_{tijk} \cdot X_{tijk}\right) (48)
$$
...
$$
Max\left(\sum_s income(A_n)^s \cdot P_s\right) (49)
$$
