...
利用图 3 中的几何关系，我们可以写出表格中相关参数的计算方式。其中 $W_{i}$记为 $( \frac{W_i}{2} )_{\text{左}}$， $W_{i}$记为 $( \frac{W_i}{2} )_{\text{右}}$。
...
$$
\frac{\sin( \frac{\pi - \theta}{2} - \alpha )}{D_{i\text{左}}} = \frac{\sin\frac{\theta}{2}}{( \frac{W_i}{2} )_{\text{左}}} (5)
$$
...
$$
\frac{\sin( \frac{\pi - \theta}{2} + \alpha )}{D_{i\text{右}}} = \frac{\sin( \frac{\theta}{2} )}{( \frac{W_i}{2} )_{\text{右}}} (6)
$$
...
$$
( \frac{W_i}{2} )_{\text{左}} + ( \frac{W_i}{2} )_{\text{右}} = W_{i\text{总}} (7)
$$
...
$$
W_i = D_i \cdot \frac{\sin\theta}{2} [ \frac{1}{\sin( \frac{\pi - \theta}{2} + \alpha )} + \frac{1}{\sin( \frac{\pi - \theta}{2} - \alpha )} ] (8)
$$
...
$$
d' = d \cdot \frac{\cos( \frac{\theta}{2} - \frac{\alpha}{2} )}{\cos( \frac{\theta}{2} - \alpha + \frac{\alpha}{2} )} (10)
$$
...
$$
\mathbf{A}_{\text{坡}} = \sqrt{(\frac{h}{d_{\text{水平}}})^2 + (\frac{h}{d_{\text{水平}} \cdot \tan \theta})^2} = \tan \alpha \cdot \cos \theta (11)
$$
...
$$
W_{\text{覆}} = d_{\text{深}} \cdot \tan \frac{\beta}{2} ( \frac{1}{\tan(\alpha - \frac{\beta}{2})} - \tan \alpha + \frac{1}{\tan(\alpha + \frac{\beta}{2})} + \tan \alpha ) (13)
$$
...
$$
( \frac{W_{\text{左}}}{2} ) + ( \frac{W_{\text{右}}}{2} ) - \Delta d = W_{\text{重}} (18)
$$
...
$$
d_{\text{测}-1} \cdot \tan \frac{\beta}{2} \cdot \theta + d_{\text{测}} \cdot \tan \frac{\beta}{2} \cdot \theta - d_{\text{测}-1} - d_{\text{测}} \cdot \tan \alpha = \eta \cdot d_{\text{测}} \cdot \tan \frac{\beta}{2} ( \frac{1}{\theta} + \frac{1}{\theta} ) (20)
$$
...
$$
d_{\text{测}} = \frac{d_{\text{测}-1} \cdot \tan \frac{\beta}{2} \cdot \theta - 1 \cdot \tan \alpha \cdot \tan \frac{\beta}{2} ( \frac{1}{\theta} + \frac{1}{\theta} ) - \tan \frac{\beta}{2} \cdot \theta - 1}{\tan \alpha} (21)
$$
